...
https.get('https://api.openweathermap.org/data/2.5/weather?q=Warsaw,pl&APPID=6e4f748efd51cdf7bdc15e6c9710fda8', (resp) => {
  let data = '';
  ...
  resp.on('end', () => {
    client.subscribe("pobierzDanePogodowe", async function({ task, taskService }) { // nazwa musi być taka jak w aktywności pole Topic
